...
if $LANG=='hu'
  ...
  menutrans &Add\ current\ file		&Aktu疝is\ f疔l\ hozz畭d疽a
  menutrans &Remove			&Elt疱ol咜疽
  menutrans &Remove\ current\ file	&Aktu疝is\ f疔l\ elt疱ol咜疽a
  menutrans &Edit\ favourites		K&edvencek\ rendez駸e
  menutrans Re&fresh			A&ktualiz疝疽
en

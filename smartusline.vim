...
" ñxñÏ éÁçé	Last Change:2013/01/22 15:57:43.
" smartusline.vim
" ---------------------------------------------------------------
" Version:  0.3
...
augroup SmartusLine
  autocmd!
  autocmd WinEnter * call SmartusLineWin('Enter')
  autocmd WinLeave * call SmartusLineWin('Leave')
    " this shouldn't be needed, but it is
  autocmd GUIEnter * execute 'hi StatColor ' g:smartusline_hi_normal
augroup END
